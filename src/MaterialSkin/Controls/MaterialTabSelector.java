...
public class MaterialTabSelector extends Control
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setBaseTabControl(MaterialTabControl value) {
    try {
      javonetHandle.set("BaseTabControl", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public MaterialTabControl getBaseTabControl() {
    try {
      Object res = javonetHandle.<NObject>get("BaseTabControl");
      if (res == null) return null;
      return new MaterialTabControl((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public MaterialTabSelector() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("MaterialSkin.Controls.MaterialTabSelector");
  ...
  public MaterialTabSelector(NObject handle) {
    super(handle);
