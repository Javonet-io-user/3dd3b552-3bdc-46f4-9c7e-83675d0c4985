...
public class MaterialTabControl extends TabControl
  ...
  public MaterialTabControl() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("MaterialSkin.Controls.MaterialTabControl");
  ...
  public MaterialTabControl(NObject handle) {
    super(handle);
