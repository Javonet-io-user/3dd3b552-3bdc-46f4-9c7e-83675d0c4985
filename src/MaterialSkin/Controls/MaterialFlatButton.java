...
public class MaterialFlatButton extends Button
  ...
  public void setPrimary(java.lang.Boolean value) {
    try {
      javonetHandle.set("Primary", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.Boolean getPrimary() {
    try {
      java.lang.Boolean res = javonetHandle.get("Primary");
  ...
  public MaterialFlatButton() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("MaterialSkin.Controls.MaterialFlatButton");
  ...
  public MaterialFlatButton(NObject handle) {
    super(handle);
