...
public class MaterialCheckBox extends CheckBox
  ...
  public void setMouseLocation(Point value) {
    try {
      javonetHandle.set("MouseLocation", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public Point getMouseLocation() {
    try {
      Object res = javonetHandle.<NObject>get("MouseLocation");
      if (res == null) return null;
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setRipple(java.lang.Boolean value) {
    try {
      javonetHandle.set("Ripple", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.Boolean getRipple() {
    try {
      java.lang.Boolean res = javonetHandle.get("Ripple");
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setAutoSize(java.lang.Boolean value) {
    try {
      javonetHandle.set("AutoSize", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.Boolean getAutoSize() {
    try {
      java.lang.Boolean res = javonetHandle.get("AutoSize");
      if (res == null) return false;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public MaterialCheckBox() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("MaterialSkin.Controls.MaterialCheckBox");
  ...
  public MaterialCheckBox(NObject handle) {
    super(handle);
  ...
  public Size GetPreferredSize(Size proposedSize) {
    try {
      Object res = javonetHandle.invoke("GetPreferredSize", proposedSize);
      if (res == null) return null;
