...
public class MaterialRaisedButton extends Button
  ...
  public MaterialRaisedButton() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("MaterialSkin.Controls.MaterialRaisedButton");
  ...
  public MaterialRaisedButton(NObject handle) {
    super(handle);
